...
// Constants
export default function PurchaseOrderScreen({ navigation, route }) {
    ...
    const orderType = route.order_type == undefined ? 'purchase' : routeParams.order_type;
