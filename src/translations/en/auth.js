export default {
  ...
  welcome_to_butike_app: "A Firm. Dependable. Working Shop Manager.",
  accept_tc_and_continue: "Accept & Continue",
  welcome_to_butike_app_description:
    "With Butike, you'll get simple, secure, reliable management and insights to grow your business for free.",
  if_you_can_use_whatsapp_you_can_use_butike:
    "If you can use WhatsApp, You can use Butike App.",
