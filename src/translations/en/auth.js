export default {
  login: 'Login',
  continue: 'Continue',
  otp_title: 'Enter the code we sent you',
  ...
  welcome_to_dukapp_app_description:
    "With Dukapp, you'll get simple, secure, reliable management and insights to grow your business for free.",
  if_you_can_use_whatsapp_you_can_use_butike: 'If you can use WhatsApp, You can use Dukapp.',
